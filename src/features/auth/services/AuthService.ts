...
export class AuthService {
  ...
  async register(
    ...
    password: string,
    fullName?: string,
  ): Promise<{ success: boolean; message?: string; user?: UserRow ; code?: string }> {
    ...
    await this.repo.createUser({username: username, password_hash: passwordHash,full_name: fullName});
